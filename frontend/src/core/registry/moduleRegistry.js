...
export const MODULE_REGISTRY = [
  ...
  { key: "sales-command", label: "Sales Command Center",  to: "/admin/sales-command-center", icon: TrendingUp,      area: "os", group: "operaciones", requiredFeature: null, flag: null, visibleToRoles: ["admin", "admin_general"] },
